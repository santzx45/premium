...
sed -i "s/   - XRAY VLESS TCP          : $tls/   - XRAY VLESS TCP          : $tls1/g" /root/log-install.txt
...
sed -i "s/   - XRAY VLESS None TCP     : $none/   - XRAY VLESS None TCP     : $none1/g" /root/log-install.txt
