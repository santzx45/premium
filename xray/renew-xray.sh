...
sed -i "s/### $user $exp/### $user $exp4/g" /etc/xray/vlessxtls.json
sed -i "s/### $user $exp/### $user $exp4/g" /etc/xray/vlesslice.json
sed -i "s/### $user $exp/### $user $exp4/g" /etc/xray/vlessws.json
