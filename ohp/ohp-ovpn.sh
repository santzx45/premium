#!/bin/bash
#Open HTTP Puncher By Geo Gabut
...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/Sangarya/premium/main/ohp/ohp"
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/Sangarya/premium/main/ohp/ohp.sh"
wget -O /usr/local/bin/ohp-db "https://raw.githubusercontent.com/Sangarya/premium/main/ohp/ohp-db.sh"
...
[Service]
ExecStart=/usr/local/bin/ohp -port 8383 -proxy 127.0.0.1:3128 -tunnel 127.0.0.1:1194
Restart=always
RestartSec=3
[Install]
